...
<div className="relative w-full bg-gray-50 rounded-3xl overflow-hidden">
      ...
      <div className="relative h-[600px] overflow-hidden">
        ...
        >
          {tournaments.map((tournament, index) => (
            <div key={tournament.id} className="w-full flex-shrink-0 relative bg-gray-50">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-gray-50 backdrop-blur-sm p-4 z-30">
        <div className="flex items-center justify-between w-full mx-auto">
          ...
          <div className="flex items-center space-x-4 text-sm text-gray-600">
            ...
            <button
              ...
              className="flex items-center space-x-2 bg-gray-50 hover:bg-gray-100 text-gray-700 px-3 py-2 rounded-lg transition-all duration-300"
